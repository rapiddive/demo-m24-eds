...
## Environments
- Preview: https://main--demo-m24-eds--rapiddive.aem.page/
- Live: https://main--demo-m24-eds--rapiddive.aem.live/
...
1. Open the `demo-m24-eds` directory in your favorite IDE and start coding :)
